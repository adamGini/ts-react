...
// -------------- property types
  ...
  // fancy way (redundant in this use-case, but shows how), includes creating a custom hook as-well:
  const useNumber = (initialValue: number) => useState<number>(initialValue)

  type UseNumberValue = ReturnType<typeof useNumber>[0] // command+hover will show this is an array of two types, since this is part of the return types. we only want the first one so - [0]
...
// detailed and custom html props:
  ...
  ) // used for the incrementer2 button (above)
  // this component has its own style, but allows for additional styles to be used, its own props, but allows for additional ones. AND it can take children OR a title.
